...
# load once at module startup — avoids disk I/O on every prediction request
...
def predict_travel_time(
    ...
    # feature order must match training exactly — XGBoost does not use column names at inference
    features = np.array([[
        distance_km,
